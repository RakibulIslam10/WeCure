...
class AllCategoryScreenMobile extends GetView<AllCategoryController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(
              () => controller.isLoadingSpecialities.value && controller.specialitiesList.isEmpty
              ? LoadingWidget()
              : GridView.builder(
            itemCount: controller.specialitiesList.length + (controller.specialitiesHasMore.value ? 1 : 0),
